    ...
    <section className="py-16 md:py-20 bg-gradient-to-br from-primary/10 to-accent/10">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 md:mb-12 bg-white rounded-2xl shadow-lg p-6 border border-primary/20 text-center">
          ...
          <p className="text-muted-foreground text-base md:text-lg">Selected papers will be considered for publication in a scholarly journal (subject to peer review).</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-primary/20">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8 text-center">
              <div>
                ...
                <div className="text-xs md:text-sm text-muted-foreground mb-2">Head, Amity School of Languages<br/>Amity University Rajasthan</div>
